const TAMANHOS = {
  ...
  pagina: { classe: "cabecalho__brasao cabecalho__brasao--pagina", arquivo: "/brasao.png", largura: 331, altura: 360 },
} as const;
...
export function Brasao({ tamanho }: { tamanho: keyof typeof TAMANHOS }) {
  ...
  return (
    <img
      ...
      width={largura}
      height={altura}
      alt={tamanho === "barra" ? "" : "Brasão do Apostolado Nossa Senhora das Neves"}
      aria-hidden={tamanho === "barra" ? true : undefined}
      loading={tamanho === "barra" ? "lazy" : "eager"}
      decoding="async"
    />
  );
}
